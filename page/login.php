            ...
            <div id="login-form" class="form-content">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" id="username" name="username" class="input-field" placeholder="Masukkan Email Anda" required>
                    </div>
                    <!-- Input Password -->
                    <div class="form-group">
                        <label for="password">Password</label><br>
                        <input type="password" id="password" name="password" class="input-field" placeholder="Masukkan Password Anda" required>
                    </div>
                    <!-- Tombol Login -->
            ...
            <div id="register-form" class="form-content" style="display: none;">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" name="fullname" class="input-field" placeholder="Masukkan Nama Lengkap Anda" required>
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label><br>
                        <input type="email" id="email" name="email" class="input-field" placeholder="Masukkan Email Anda" required>
                    </div>
                    <div class="form-group">
                        <label for="register-password">Password</label><br>
                        <input type="password" id="register-password" name="register-password" class="input-field" placeholder="Masukkan Password Anda" required>
                    </div>
                    <!-- Tombol Registrasi -->
                    <button type="submit" class="login2-button">Registrasi</button>
